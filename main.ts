//Assigment Solution
// Task 11
let names : string [] = ["Saim","Afridi","Raed","Khan"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
// Reverse the order of the list again to get back to the original order placesToVisit.reverse();
...
///roduce an index error. make sure you correct the error before closing the program.
